...
export function BookListItem({title, author, img, desc, link}) {
    return (
        <div className="card mx-2 mt-2">
          <div className="row">
            ...
            <div className="col-8">
              ...
              <Link to={{ pathname: link }} target="_blank"><button className="mr-1">View</button></Link>
                <button>Save</button>
              </div>
            </div>
          </div>
          <div className="row mt-2 mb-2">
            ...
            <div className="col-8 mt-1 ml-2">
              <p>{desc}</p>
              <Link to={{ pathname: link }} target="_blank">You like book?  Go to book.</Link>
